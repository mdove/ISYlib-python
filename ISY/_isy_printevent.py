    ...
    try:
        ...
        #    return
            ...
            if ddat["eventInfo"] is not None:
                ...
                evi = ""
            print(
                "{!s:<7} {!s:<4}\t{!s:<12}{!s:<12}\t{!s:<12}\t{!s}".format(
            ...
            if action_val == "0":
                ...
                if "nsr" in ddat["eventInfo"]:
                    st.append(
                        "nextScheduledRunTime={}".format(ddat["eventInfo"]["nsr"])
                    )
                ...
                if isinstance(ddat["eventInfo"], dict):
                    status = " ".join(
                        ["{}={}".format(a, b) for a, b in list(ddat["eventInfo"].items())]
                    )
